...
//
//class MainActivity : MvpAppCompatActivity(), BottomNavigationView {
//
...
//    }
//
//    private fun initBottomNavigationView() = with(view.bottomNavigationBar) {
...
//        if (view.bottomNavigationBar.visibility == GONE) {
//            return
//        }
//        view.bottomNavigationBar.visibility = GONE
//    }
//
//    override fun showBottomNavigation() {
//        if (view.bottomNavigationBar.visibility == VISIBLE) {
//            return
//        }
//        view.bottomNavigationBar.visibility = VISIBLE
//    }
//
//    override fun selectItem(menu: Menu) {
//        view.bottomNavigationBar.menu.findItem(when(menu){
//            Menu.HOME ->R.id.home
